...
public class GameManager {
	...
	public static int attackZombie(Zombie zombie) {
		...
		setCurrentRock(nextRock);
		setNextRock(RockManager.randomRock());
	...
	public static NormalRock getCurrentRock() {
		return currentRock;
	}

	public static void setCurrentRock(NormalRock currentRock) {
		GameManager.currentRock = currentRock;
	}

	public static NormalRock getNextRock() {
		return nextRock;
	}

	public static void setNextRock(NormalRock nextRock) {
		GameManager.nextRock = nextRock;
	}
}
